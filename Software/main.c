...
//  Enable clocks for RTC, GPIOE, GPIOD, GPIOC and TIM5.
...
//	 Use pin 7 to 11 of port D.
	GPIO_InitStructure.Pin = GPIO_PIN_4 | GPIO_PIN_7 | GPIO_PIN_8 | GPIO_PIN_9 | GPIO_PIN_10;
	GPIO_InitStructure.Mode = GPIO_MODE_OUTPUT_PP;
	GPIO_InitStructure.Speed = GPIO_SPEED_HIGH;
	GPIO_InitStructure.Pull = GPIO_NOPULL;
	GPIO_InitStructure.Alternate = 0;
...
//Initialize Real time clock time to be 00:00
	ClockTime.Hours = 00;
	...
	//HAL_RTC_SetTime(&RealTimeClock, &ClockTime, RTC_FORMAT_BCD);
...
void GetCurrentTime(void)
{
	if ( HAL_RTC_WaitForSynchro( &RealTimeClock ) == HAL_OK )
	{
		...
		BcdTime[1] = ClockTime.Seconds/10;
		BcdTime[0] = ClockTime.Seconds%10;
		BcdTime[2] = ClockTime.Hours/10;
		BcdTime[3] = ClockTime.Hours%10;
	}
}
